...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "main_navigation_navigation" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "homepage_skills" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"skill" varchar
  ...
  CREATE TABLE IF NOT EXISTS "homepage" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_id" integer NOT NULL,
  	"main_value_proposition" varchar NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "main_navigation_navigation" ADD CONSTRAINT "main_navigation_navigation_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."main_navigation"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "homepage_skills" ADD CONSTRAINT "homepage_skills_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "homepage" ADD CONSTRAINT "homepage_resume_id_media_id_fk" FOREIGN KEY ("resume_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "main_navigation_navigation_order_idx" ON "main_navigation_navigation" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "main_navigation_navigation_parent_id_idx" ON "main_navigation_navigation" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "homepage_skills_order_idx" ON "homepage_skills" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "homepage_skills_parent_id_idx" ON "homepage_skills" USING btree ("_parent_id");`)
}
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "main_navigation_navigation";
  DROP TABLE "main_navigation";
  DROP TABLE "homepage_skills";
  DROP TABLE "homepage";`)
}
