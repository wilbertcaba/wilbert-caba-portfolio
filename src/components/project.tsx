    ...
    return (
        ...
        >
            <Link href={`/projects/${slug}`}>
                <div className="bg-gray-100 border border-black/5 overflow-hidden relative sm:h-[18rem] hover:bg-gray-200 transition rounded-lg dark:text-white dark:border dark:border-neutral-600 dark:bg-neutral-800 dark:hover:bg-neutral-900">
